        ...
        <div className="flex flex-col items-center justify-between md:flex-row">
          <div className="mb-8 w-full md:mb-0 md:w-1/3">
            <img
              ...
              className="mx-auto h-[150px] w-[150px] rounded-full object-cover shadow-lg xs:h-[120px] xs:w-[120px] "
            />
          </div>
          <div className="w-full ">
            <BlurFade>
              <h2 className="mb-6 p-4 text-[50px] font-bold text-gray-800 backdrop-blur-[5px] xs:text-[40px]">
                안녕하세요!
              </h2>

              <p className="z-10 mb-4 p-4 text-[20px] leading-relaxed text-gray-600 backdrop-blur-[5px] xs:text-[18px] ">
                저는 끊임없이 성장하는 프론트엔드 개발자 장진영입니다.
                <br className="hidden sm:block"></br>
                <span className="relative">
                  <span className="relative z-10">
                    <strong className="text-[25px] text-slate-600 xs:text-[22px] ">
                      사용자 경험
                    </strong>
                  </span>
                ...
                <span className="relative">
                  <span className="relative z-10">
                    <strong className="text-[25px] text-sky-700 xs:text-[22px] ">
                      새로운 서비스를 만드는 것
                    </strong>
                  </span>
              ...
              <p className="z-10 mb-4 p-4 text-[20px] leading-relaxed text-gray-600 backdrop-blur-[5px] xs:text-[18px]">
                ...
                최신 웹 기술에 대한 열정과 학습 의지를 가지고 <br className="hidden md:block"></br>
